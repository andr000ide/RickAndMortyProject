...
public class Fragment3 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        sv = (ScrollView) rootView.findViewById(R.id.fragmento3);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(nextpage.equals("")){
                    ...
                    nextpage = parts[1];
                    Services.getInstance(getActivity()).getLocations(successListener, errorListener, nextpage);
        ...
        ib.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Services.getInstance(getActivity()).getLocationsFilter(successListener, errorListener,aux);
            }
        });
    ...
    public void prepare(){
        recyclerView = rootView.findViewById(R.id.locationAdapter);
